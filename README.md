...
<p align="center">
  <img src="docs/assets/sqbi-product-tour.gif" alt="SQ-BI 产品导览：连接数据库与 AI 生成语义空间、领域包挂载激活、个人空间对话式创建资产、智慧问数的指标下钻/技能分析/报表调用" width="920">
</p>
<p align="center"><sub>完整导览：① 连接数据库，AI 生成语义空间 → ② 领域包挂载、字段映射与激活 → ③ 个人空间对话式沉淀资产 → ④ 智慧问数：@ 指标下钻、/ 技能深度分析、# 报表</sub></p>
